...
- (void)getVideoProperties:(NSString *)videoPath resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject {
...
{
    return std::make_shared<facebook::react::NativeVideoPropertiesSpecJSI>(params);
}
