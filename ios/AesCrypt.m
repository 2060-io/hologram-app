...
+ (NSData *) AESCBC: (NSString *)operation data: (NSData *)data key: (NSData *)key iv: (NSData *)iv algorithm: (NSString *)algorithm {
...
+ (NSData *) encrypt: (NSData *)clearText key: (NSData *)key iv: (NSData *)iv algorithm: (NSString *)algorithm {
    NSData *result = [self AESCBC:@"encrypt" data:clearText key:key iv:iv algorithm:algorithm];
    return result;
}

+ (NSData *) decrypt: (NSData *)cipherText key: (NSData *)key iv: (NSData *)iv algorithm: (NSString *)algorithm {
    NSData *result = [self AESCBC:@"decrypt" data:cipherText key:key iv:iv algorithm:algorithm];
    return result;
}
