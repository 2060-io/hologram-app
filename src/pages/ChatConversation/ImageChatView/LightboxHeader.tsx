...
import { MediaInfo } from '../ChatConversationProps'
...
const LightboxHeader = memo(({ fileMediaInfo, onBack, chatEntry }: LightboxHeaderProps) => {
  ...
  const handleSaveFileToGallery = () => {
    saveFileToGallery(chatEntry)
      .then(() => Alert.alert(t('chatConversation.saveSucceededFileMedia')))
      .catch(() => Alert.alert(t('chatConversation.saveFailedFileMedia')))
  }
