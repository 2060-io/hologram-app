...
import { BaseCustomMessageViewProps } from '@2060/pages/ChatConversation/ChatMessage/Props'
        ...
        case ChatEntryType.Answer:
          return (
            <UserActionChatView
              ...
              title={t('chatConversation.response')}
              iconName="question"
            />
          )
        case ChatEntryType.ActionMenuSelection:
          return (
            <UserActionChatView
              ...
              title={t('chatConversation.menuActionSelected')}
