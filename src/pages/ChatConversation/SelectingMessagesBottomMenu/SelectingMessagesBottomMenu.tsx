...
const SelectingMessagesBottomMenu = ({
  ...
  const confirmDeleteForEveryone = () => {
    ...
    return canDeleteForEveryone ? t('chatConversation.deleteForEveryone') : undefined
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <ModalConfirmAction
        ...
        title={t('chatConversation.deleteMessageConfirmation', { count: selectedMessages.length })}
