...
import ChatConversationContainer, { WrapperChatConversationProps } from './ChatConversationContainer'
...
import { ChatMessageList } from '@2060/pages/ChatConversation/ChatMessageList'
...
interface ChatConversationProps extends WrapperChatConversationProps {
...
const ChatConversation = ({
  ...
  const confirmDeleteForEveryone = () => {
    ...
    return isNotDeleted && isSender ? t('chatConversation.deleteForEveryone') : undefined
  }
  ...
  return (
    <>
      ...
      <ModalConfirmAction
        ...
        title={t('chatConversation.report')}
        subTitle={t('chatConversation.reportDetails')}
        confirmText={t('chatConversation.report')}
        confirmTextSecondary={t('chatConversation.reportAndBlock')}
      ...
      <ModalConfirmAction
        ...
        title={t('chatConversation.deleteMessageConfirmation', { count: 1 })}
        confirmText={t('chatConversation.deleteForMe')}
...
const ChatConversationMemo = memo(ChatConversation, (prevProps, nextProps) => {
  return (
...
export default ChatConversationContainer(ChatConversationMemo)
