...
const Chat = ({ chatEntries, chatThread, navigation, loadMoreMessages, redirectToHomeOnBack }: ChatProps) => {
  ...
  const confirmDeleteForEveryone = () => {
    ...
    return isNotDeleted && isSender ? t('chat.deleteForEveryone') : undefined
  }
  ...
  return (
    <>
      ...
      <ModalConfirmAction
        ...
        title={t('chat.report')}
        subTitle={t('chat.reportDetails')}
        confirmText={t('chat.report')}
        confirmTextSecondary={t('chat.reportAndBlock')}
      ...
      <ModalConfirmAction
        ...
        title={t('chat.deleteMessageConfirmation', { count: 1 })}
        confirmText={t('chat.deleteForMe')}
...
const ChatMemo = memo(Chat, (prevProps, nextProps) => {
  return (
...
export default ChatContainer(ChatMemo)
