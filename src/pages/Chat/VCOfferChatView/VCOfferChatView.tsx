...
const VCOfferChatView = ({
  ...
  const status: Partial<Record<DidCommCredentialState, React.ReactElement>> = {
    ...
    [DidCommCredentialState.Declined]: <State text={t('chat.youRefusedCredential')} type="error" />,
    [DidCommCredentialState.CredentialReceived]: <State text={t('chat.credentialAdded')} />,
    [DidCommCredentialState.Done]: <State text={t('chat.credentialAdded')} />,
  }
  return (
    <View style={styles.container}>
      ...
      <View style={styles.subContainer}>
        <Text style={styles.title}>
          {t('chat.offeringCredential', { sender: metadata.issuerName ?? sender?.name })}
        </Text>
